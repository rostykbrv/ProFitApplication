    ...
    public partial class HomeWorkoutPageViewModel:BaseViewModel
    {
        ...
        public HomeWorkoutPageViewModel()
        {
            ExerciseGroups = new ObservableCollection<ExerciseGroup>
            {
                ...
                new ExerciseGroup
                {
                    ExerciseGroupName="Тренування для всього тіла",
                    ExerciseGroupDescription="Програма складається з вправ на верхню та нижню частину тіла. Створення для загального тренування. Ці вправи допомагають зміцнити м'язи та покращити координацію рухів.",
                    ExerciseGroupLevel="Продвинутий",
                    ExerciseGroupImage="fulltraining.jpeg",
                    ExerciseGroupKcal="315",
                    ExerciseGroupTimeSpent="45"
                },

                new ExerciseGroup
                {
                    ExerciseGroupName="Вправи з власною вагою",
                    ExerciseGroupDescription="Це тренування допомагає зміцнити м'язи та покращити координацію рухів, не потребує спеціального обладнання та може бути виконане в будь-якому місці.",
                    ExerciseGroupLevel="Продвинутий",
                    ExerciseGroupImage="bodyweighttraining.jpeg",
                    ExerciseGroupKcal="180",
                    ExerciseGroupTimeSpent="20"
                },

                new ExerciseGroup
                {
                    ExerciseGroupName="Вправи з еспандером",
                    ExerciseGroupDescription="Тренування з еспандером може стати повноцінною заміною спортзалу, якщо підходити до занять з усією серйозністю. Вправи з еспандером дозволяють нарощувати м’язову масу, покращувати рельєф і підвищувати витривалість, тренуючись в домашніх умовах, на спортмайданчику або навіть під час відпочинку.",
                    ExerciseGroupLevel="Продвинутий",
                    ExerciseGroupImage="resistancebandtraining.jpeg",
